    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => [
                ...
                'unique:report_compositions,slug',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
            ],
            'description' => ['nullable', 'string', 'max:5000'],
            'page' => ['required', 'array'],
            'page.width' => ['required', 'numeric', 'min:10', 'max:2000'],
            'page.height' => ['required', 'numeric', 'min:10', 'max:2000'],
            'page.margin' => ['required', 'array'],
            'page.margin.top' => ['required', 'numeric', 'min:0'],
            'page.margin.right' => ['required', 'numeric', 'min:0'],
            'page.margin.bottom' => ['required', 'numeric', 'min:0'],
            'page.margin.left' => ['required', 'numeric', 'min:0'],
            'pages' => ['required', 'array', 'min:1', 'max:50'],
            'pages.*.pdf_template_id' => ['required', 'integer', 'exists:pdf_templates,id'],
